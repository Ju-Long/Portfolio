		...
		<>
			<div
				style={{
					...
					clipPath: `polygon(0 0, ${partConnectorWidth / 2 + PART_CONNECTOR_DX}px 0, ${partConnectorWidth / 2 - PART_CONNECTOR_DX
						}px 100%, 0 100%)`,
				}}
			/>
			<div
				style={{
					...
					clipPath: `polygon(${PART_CONNECTOR_DX * 2} 0, ${partConnectorWidth / 2 + PART_CONNECTOR_DX
